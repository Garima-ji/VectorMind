        ...
        <div className="px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl space-y-8">
            ...
            <div className="rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm p-6 shadow-lg">
              <h2 className="mb-6 text-lg font-semibold text-foreground">AI Insights</h2>
              <div className="grid gap-6 sm:grid-cols-3">
                ...
                {/* Dominant Cluster */}
                <div className="rounded-xl border border-border/50 bg-muted/30 p-4">
                  <p className="text-sm font-medium text-muted-foreground">Dominant Cluster</p>
                  <p className="mt-2 text-2xl font-bold text-foreground">
                    ...
                    >
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Additional Fields */}
                          {Object.entries(item).filter(([key]) => !['title', 'content', 'score', 'id', 'cluster'].includes(key)).length > 0 && (
                            <div className="mt-3 flex flex-wrap gap-3">
                              {Object.entries(item).map(([key, value]) => {
                                if (['title', 'content', 'score', 'id', 'cluster'].includes(key)) return null
                                return (
      ...
      {!data && !error && !loading && (
        <div className="flex items-center justify-center min-h-[50vh] px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h3 className="text-xl font-semibold text-foreground">Ready to explore</h3>
